...
from pythreejs import Mesh, SphereBufferGeometry, OrbitControls, MeshStandardMaterial, PerspectiveCamera, Scene, Renderer, AmbientLight
...
class Model:
    ...
    """
    def __init__(self, *hand_content: List[dict], pattern: List[Tuple[int, int]] = [(1, 0)]):
        balls: List[Ball] = []
