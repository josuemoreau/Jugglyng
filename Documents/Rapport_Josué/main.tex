...
\includegraphics{figure-do_re_mi}
\includegraphics{figure-re_do_mi}

\includegraphics{figure-3_1_2}

\includegraphics{figure-2_3_2}
\includegraphics{figure-3_0_3_0}

\includegraphics{figure-13_2_0}

\includegraphics{figure-aplatissement}

\includegraphics{figure-multihand}

\includegraphics{figure-pre_traitement}

\includegraphics{figure-pre_traitement_timeline}

\includegraphics{figure-automate}

\includegraphics{figure-automate_musical}
